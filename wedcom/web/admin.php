...
<head>
    ...
    .logout-btn {
        ...
        margin-bottom: 100px; /* เพิ่มระยะห่างจากขอบล่าง */
    }
    .logout-btn:hover {
...
<body>
    <div class="sidebar">
        ...
        <a href="add_points.php">เติม Point</a>
        <a href="delete_points.php">ลบ Point</a>
